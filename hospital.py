...
class Hospital:
    def __init__(self,root):
        ...
        btnPrescriptionDetails = Button(ButtonFrame,fg='green',bg='white',text="Prescription Data",font=("arial",12,"bold"),width=23,padx=2,pady=6)
        btnPrescriptionDetails.grid(row=0,column=1)


        btnUpdate= Button(ButtonFrame,text="Update",fg='green',bg='white',font=("arial",12,"bold"),width=23,padx=2,pady=6)
        btnUpdate.grid(row=0,column=2)
                       

        btnDelete = Button(ButtonFrame,text="Delete",fg='green',bg='white',font=("arial",12,"bold"),width=23,padx=2,pady=6)
        btnDelete.grid(row=0,column=3)

        btnInsert = Button(ButtonFrame,text="Clear",fg='green',bg='white',font=("arial",12,"bold"),width=23,padx=2,pady=6)
        btnInsert.grid(row=0,column=4)

        btnExit = Button(ButtonFrame,text="Exit",fg='green',bg='white',font=("arial",12,"bold"),width=23,padx=2,pady=6)
